...
import { PresenceProvider } from '@/features/presence/hooks/use-presence';
...
function DashboardLayoutContent({
  ...
  return (
    <KBar>
      {/* One presence socket for the whole tab: the header's status picker and
          every dot in every feature read the same cache. */}
      <PresenceProvider>
