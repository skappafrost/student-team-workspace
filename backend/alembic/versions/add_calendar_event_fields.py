...
down_revision: str | Sequence[str] | None = "add_task_position"
...
def upgrade() -> None:
    ...
    op.add_column(
        "events", sa.Column("all_day", sa.Boolean(), nullable=False, server_default="false")
    )
    op.add_column(
        "events",
        sa.Column("event_type", sa.String(length=50), nullable=False, server_default="reminder"),
    )
    op.add_column(
        "events", sa.Column("created_by", sa.String(length=36), nullable=False, server_default="")
    )
    op.add_column(
        "events",
        sa.Column(
